...
Google Calendar is currently a read-only private ICS source. Events created in the planner stay in D1; they are NOT written to Google Calendar. Complete the losapalas OAuth authorization before enabling event writes. Family Gmail may require reauthorization independently; ingestion must fail closed.
